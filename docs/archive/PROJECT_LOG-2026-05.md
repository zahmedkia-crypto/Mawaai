# PROJECT_LOG (archived 2026-05-28, MT-003)

> This file was the rolling project log up through 2026-05. It has been moved to
> `docs/archive/` because parts of it (Pexels, Supabase, romantic-side screens)
> describe features that no longer exist in source. Treat as **historical**.
>
> Reconciliation: `PROJECT_SCAN_CONTINUATION_2026-05-22.md` § "Reconciliation Note (MT-003)".
>
> For current work, see the open PRs and `PROJECT_SCAN_2026-05-22.md`.
